...
\titulo{Prognosis Machine : a proposal for failure prediction in robotic systems}
\tituloestrangeiro{}
\autor{
      Alexandre Adonai\thanks{``Recomenda-se que os dados de vinculação e endereço constem em nota, com sistema de chamada próprio, diferente do sistema adotado para citações no texto.'' \url{http://www.abntex.net.br/}} 
      %\\[0.5cm] 
      Pedro Moreira\thanks{``Constar currículo sucinto de cada autor, com vinculação corporativa e endereço de contato.''} 
      Marco Reis\thanks{``PhD candidate in computational modeling and industrial technology program at the senai cimatec university center.''} 
      }
\local{Brasil}
\data{25/05/2022}
% ---
